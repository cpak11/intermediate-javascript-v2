...
function async(){
	...
	return defer.promise.then(resolve=>resolve());
}
...
CoinToss.prototype.flip = function(){
	...
	if(randnum == 1) this.results.push('heads');
	else this.results.push('tails');
	return this.results;
}
// #10  ###################
// # Closure 1
...
function compareValues(x,y){
	if(x===y) return "Exact match";
	if(x==y) return "Different types";
